...
public class CircleTest extends junit.framework.TestCase
{
	...
	/**
	 * Zwei Kreise mit gleichem Mittelpunkt, einen verschieben, sollten anderen Mittelpunkt haben
	 */
	@Test
	public void testEinMittelpunkt( )
	{
		...
		// Mittelpunkte sollten nicht auf dasselbe Objekt zeigen/immer Kopien sein
	...
	{
		// Mittelpunkte via getCenter( ) und getFirstPoint( ) sollten nicht auf dasselbe Objekt zeigen
